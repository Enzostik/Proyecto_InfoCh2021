...
INSTALLED_APPS = [
    ...
    'useradministrator.apps.UseradministratorConfig', #app para los privilegios admin
]
...
ROOT_URLCONF = 'Proyecto_InfoCh2021.urls'
...
WSGI_APPLICATION = 'Proyecto_InfoCh2021.wsgi.application'
